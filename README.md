...
- `shells/windows/lib/setup-vscode.cmd`
...
Subsystem-specific package manifests are stored under `shells/bash/<subsystem>/` and generated by the shared helper in `shells/bash/lib/create-manifest.sh`.
